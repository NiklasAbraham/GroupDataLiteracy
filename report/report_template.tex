...
% fig, ax = plt.subplots(1, 2)
    \includegraphics{../figures/epsilon_ball_analysis/ks_test_temporal_Spectre__The_World_Is_Not_Enough__Tomorrow_Never_Dies__Casino_Royale__Casino_Royale__GoldenEye__Quantum_of_Sola__501cadb7_eps0.28.pdf}
    \caption{KS test on temporal distributions for James Bond epsilon ball ($\varepsilon = 0.28$) versus control group. Left: Cumulative distribution functions of release years showing divergence beginning in the 1960s. Right: Normalized histograms of movie counts per year, revealing distinct temporal patterns in spy film production compared to the broader corpus.}
