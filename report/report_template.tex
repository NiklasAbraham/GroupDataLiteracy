...
\begin{table}[ht]
    \centering
    \caption{Summary of results for each chunking method and embedding configuration. The best value in each column is shown in bold.}
    \begin{tabular}{lccccccc}
        \toprule
        Method & \makecell{Length\\normcorr} & \makecell{Isotropy\\1st~PC} & \makecell{Isotropy\\abtt2} & \makecell{Mean\\Between\\Dist.} & \makecell{Silhouette\\Score} & \makecell{Genre\\Accuracy} & \makecell{Genre\\F1} \\
        \midrule
        MeanPooling & 0.643 & 12.23 & \textbf{3.43} & \textbf{0.59} & -0.18 & 0.46 & 0.35 \\
        CLS Token & -0.01 & 5.14  & 2.22 & 0.57 & -0.11 & \textbf{0.47} & \textbf{0.36} \\
        ChunkFirst~E. 512/256 & -0.38 & 5.83  & 2.26 & 0.56 & -0.12 & \textbf{0.47} & \textbf{0.36} \\
        ChunkFirst~E. 1024/512 & -0.32 & 5.28  & 2.22 & 0.57 & -0.11 & \textbf{0.47} & \textbf{0.36} \\
        ChunkFirst~E. 2048/1024 & -0.09 & 5.14  & 2.22 & 0.57 & -0.11 & \textbf{0.47} & \textbf{0.36} \\
        LateChunking~512/256 & \textbf{0.84} & \textbf{12.58} & \textbf{3.43} & \textbf{0.59} & -0.18 & 0.46 & 0.35 \\
        LateChunking~1024/512 & 0.75 & 12.32 & \textbf{3.43} & \textbf{0.59} & -0.18 & 0.46 & 0.35 \\
        LateChunking~2048/1024 & 0.66 & 12.23 & \textbf{3.43} & \textbf{0.59} & -0.18 & 0.46 & 0.35 \\
        LateChunking~2048/512 & 0.66 & 12.23 & \textbf{3.43} & \textbf{0.59} & -0.18 & 0.46 & 0.35 \\
        LateChunking~512/0 & \textbf{0.84} & 12.24 & 3.42 & \textbf{0.59} & -0.18 & 0.46 & 0.35 \\
        LateChunking~1024/0 & 0.75 & 12.16 & 3.42 & \textbf{0.59} & -0.18 & 0.46 & 0.35 \\
        LateChunking~2048/0 & 0.66 & 12.23 & \textbf{3.43} & \textbf{0.59} & -0.18 & 0.46 & 0.35 \\
        \bottomrule
    \end{tabular}
