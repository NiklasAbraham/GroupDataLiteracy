...
\begin{itemize}
    ...
    \item \textbf{Niklas Abraham:} Led embedding model selection and evaluation, analyzed chunking methods, and performed KS test and distance distribution analysis.
\end{itemize}
