...
To compute these scores, we use the Faiss library \cite{douze2024faiss}.
...
The resulting plot indicates that the average yearly novelty remained relatively constant from the 1950s onwards.
